...
from secmlware.datasets.random_drs_dataset import RandomDRSDataset
...
trainer = SmoothingClassifierTrainer(num_epochs=5, patience=2, output_directory_path="models/random_drs_malconv/")
